...
def moving_average(a, w=3):
    ...
    print(n,d)
    res = []
    range1 = np.arange(0,n-w,w) # start sequence from 0 size to n-w
...
def moving_average_set(a, window=3) :
    ...
    print("moving average set : ",c0.shape, c1.shape)
    ...
    #print(m_c0.shape, m_c1.shape)
    res= np.concatenate((m_c0,m_c1),axis=1)
    return res
